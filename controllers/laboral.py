...
class LaboralesController(Resource):
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Falta ingresar la empresa laboral"
    )
    parser.add_argument(
        "cargo",
        type=str,
        required=True,
        help="Falta ingresar el cargo laboral"
    )
    parser.add_argument(
        "fecini",
        type=str,
    ...
    def post(self):
        ...
        laboral = LaboralModel(data['empresa'],data['cargo'],data['fecini'],data['fecfin'], data['contacnombre'], data['contaccelular'], data['observacion'],data['estado'],data['per_id'])
        try:
            laboral.guardar_bd()
            print(laboral)
            return {
...
class LaboralController(Resource):
    ...
    def put(self, lab_id):
        ...
        if laboral:
            ...
            laboral.empresa = data['empresa']
            laboral.cargo = data['cargo']
