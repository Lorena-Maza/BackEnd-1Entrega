...
class ConocimientosController(Resource):
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="Falta ingresar las horas de estudio"
    )
    parser.add_argument(
        "observacion",
        type=str,
    ...
    def post(self):
        ...
        conocimiento = ConocimientoModel(data['descripcion'],data['fecini'],data['fecfin'], data['cestudios'], data['horas'], data['observacion'],data['estado'],data['per_id'])
        try:
    ...
    def put(self, conoci_id):
        ...
        if conocimiento:
            ...
            parser.add_argument(
                ...
                type=int,
                required=True,
                help="Falta ingresar las horas de estudios"
            )
            parser.add_argument(
                "observacion",
                type=str,
